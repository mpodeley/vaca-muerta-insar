#!/usr/bin/env python
"""Pozos de Bajo del Choique - La Invernada (Cap IV) → _data/choique_wells_all.json, mismo esquema que
...
LCA de concesiones (sanity geométrico).
    ...
    ~/miniforge3/bin/mamba run -n insar python exploraciones/choique/choique_wells.py
"""
...
CONC_ID = "BCLI"
OUT = DATA / "choique_wells_all.json"
