#!/usr/bin/env python
"""La Calera DESC 40 m — encarga interferogramas multi-burst a HyP3 (ISCE2, looks 10x2).
Cubre el bloque LCA + margen oeste (el pico de subsidencia toca el borde) con el
strip IW2 de 4 bursts del track 10 DESC (S1C, desde 2025-08): 010_020639..020642.
Para descomposición vertical/E-O contra el stack ascendente calera-int40.
...
BURSTS = ["010_020639_IW2", "010_020640_IW2", "010_020641_IW2", "010_020642_IW2"]
START, END = "2025-08-01", "2026-08-01"
NEIGHBORS = 3
NAME, TAG = "calera-d10", "d10"
LOOKS = "10x2"
...
def monthly_dates(results) -> dict:
    ...
    # ventana corta (S1C desde 2025-08): usar TODAS las fechas con los 4 bursts
    return {d: v for d, v in sorted(per_date.items()) if len(v) == len(BURSTS)}
